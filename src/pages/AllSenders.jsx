...
import FilterPills from '@/components/senders/FilterPills'
import SortControls from '@/components/senders/SortControls'

export default function AllSenders() {
  const { settings } = useApp()
  const { senders, allFiltered, total, search, setSearch, filterCategory, setFilterCategory, sortBy, setSortBy, page, setPage, totalPages, pageSize } = useSenders()
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-display font-bold text-zinc-50 tracking-tight">All Senders</h1>
      ...
      <FilterPills value={filterCategory} onChange={setFilterCategory} />
